...
# 2. 遍历 dev-small docs_iter，只写相关的到 collection.tsv
with open("collection.tsv", "w", encoding="utf-8") as fout:
...
print(f"✅ Wrote collection.tsv with {len(relevant_pids)} lines.")
